...
var quizContainerSelect = document.querySelector('#quiz-container');
var previousButtonSelect = document.querySelectorAll("#previous");
var nextButtonSelect = document.querySelectorAll("#next");
var submitButtonSelect = document.querySelectorAll("#submit");
...
// Adding styling to the quiz-container
quizContainerSelect.setAttribute('style', 'color: #3b4954; font-size: 18px; line-height: 1.4; margin: 0 auto; max-width: 800px; padding: 30px 40px; text-align: center;');

// Adding styling to the button navigation section
